...
public class ProgramTestMRU {
	...
	public void test1() {
        ...
        sac.put('B', 7);
        sac.print();
        assertEquals(0, sac.get('A'));
        assertEquals(7, sac.get('B'));
        assertEquals(6, sac.get('D'));
	...
	//Blocks per set: 2, Sets per cache: 3
	@Test
	public void test5() {
		Policy<Integer> policy = new PolicyMRU<>();
